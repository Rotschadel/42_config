...
/*   Updated: 2014/01/25 14:05:48 by mdelage          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_init_term(t_data *data)
{
	...
	if (tgetent(buffer, getenv("TERM")) < 1)
		return (-1);
	if (tgetstr("le", NULL) == NULL || tgetstr("LE", NULL) == NULL \
		|| tgetstr("ti", NULL) == NULL || tgetstr("te", NULL) == NULL \
		|| tgetstr("nd", NULL) == NULL || tgetstr("cm", NULL) == NULL \
